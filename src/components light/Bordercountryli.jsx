...
function Bordercountryli({ settoggle, toggle }) {
        ...
        <>
            ...
            <div className={`row ${style.country} mt-5 justify-content-evenly`}>
                <div className={`col-lg-5 col-md-8 col-sm-8 mt-5 ${style.imgdet}`} >
                    <Link to='/' className={`w-75 text-black border border-0 px-4 py-2 rounded ${style.back} text-decoration-none`}> <FontAwesomeIcon icon={faArrowLeft} className='me-2' /> back</Link>
...
export default Bordercountryli